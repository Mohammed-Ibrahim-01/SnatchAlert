"""
Seed data script for SnatchAlert
...
print(f"✓ Created {len(incident_types_data)} incident types")
...
print(f"✓ Created {len(stolen_items)} stolen items")
...
print(f"✓ Created {len(imei_data)} IMEI records")
...
print(f"✓ Created {len(alerts_data)} area alerts")
...
print(f"✓ Created {len(tips_data)} safety tips")
